...
<!-- /******************************************************* 
 Autor : LABG1E2
 Tipo de programa: "Vista con la lista de las eps"
...
<html lang="en">
  <head>
    ...
    <title>EPS - Tu Receta Médica</title>
  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="starter-template">
        <h1>Listado de EPS y cajas de compensación en Colombia<br></h1>
        <embed src="../assets/files/EPS.pdf" width="850" height="550" href="../assets/files/EPS.pdf"></embed>
        <p class="lead"><br></p>
      </div>
      <div class="mastfoot">
        <div class="inner">

...
<!-- /******************************************************* 
 Autor : LABG1E2
 Tipo de programa: "Vista del formulario de solicitud de tratamientos"
...
<div class="navbar-wrapper">
              ...
              <ul class="nav navbar-nav">
                <li class="dropdown">
                  ...
                  <ul class="dropdown-menu" role="menu">
                    ...
                    <li><a href="<?php echo base_url()."main/solTreatment";?>">Solicitudes de adición de medicamentos</a></li>
      ...
      <form class="well" action="<?php echo base_url()."main/treatment_request";?>" method="post" accept-charset="utf-8">
        <h2 class="form-signin-heading">Formulario solicitud de Adición de tratamientos</h2>
      ...
      <div class="modal" id="myModal">
        <div class="modal-dialog">
          ...
          <div class="modal-body">
            Este formulario es una solicitud de adicion de tratamiento que tiene que ser evaluada 
          ...
          <div class="modal-footer">
            ...
            href="<?php echo base_url()."main/treatment_request";?>">Aceptar</button>
          </div>
        </div>
      </div> 
    </div>

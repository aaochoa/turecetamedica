...
<!-- /******************************************************* 
 Autor : LABG1E2
 Tipo de programa: "Vista del administrador pacientes activos"
...
================================================== -->
  ...
  <div class="page-header">
        <h1><br><br>Pacientes Activos del sitio</h1>
  </div>
  ...
  <div class="row">
    <div class="col-lg-6">
      ...
      <form class="well" action="<?php echo base_url()."main/desactivarCuenta";?>" method="post" accept-charset="utf-8">
        <h2 class="form-signin-heading">Desactivar cuenta de paciente</h2>

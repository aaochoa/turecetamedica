...
<!-- /******************************************************* 
 Autor : LABG1E2
 Tipo de programa: "Vista del perfil del medico general/especialista"
                  ...
                  <table class="table table-user-information">
                    <tbody>
                      <tr>
                        ...
                        <td><?php echo $row->idMedicoEG;?></td>
                      </tr>
                      <tr>
                        <td>Tarifas particulares</td>
                        <td><?php echo $row->tarifasParticulares;?></td>
                      </tr>
                      <tr>
                        <td>Referencias</td>
                        <td><?php echo $row->referenciasJob;?></td>
                      </tr>
                      <tr>
                        <td>Lugar de trabajo aparte</td>
                        <td><?php echo $row->otherJobPlace;?></td>
                      </tr>
                      <tr>

...
<!-- /******************************************************* 
 Autor : LABG1E2
 Tipo de programa: "Vista del administrador, solicitudes de medicamentos"
...
<html lang="en">
  <head>
    ...
    <script language="javascript" type="text/javascript">
      ...
      {
        var x=row.cells;
        document.getElementById("idnoPOS").value = x[0].innerHTML;
        document.getElementById("idSolicitante").value = x[1].innerHTML;
        document.getElementById("nameMedicine").value = x[2].innerHTML;
        document.getElementById("howitcomes").value = x[3].innerHTML;
        document.getElementById("whatitdoes").value = x[4].innerHTML;
      }
    </script>
...
================================================== -->
  ...
  <div class="page-header">
        <h1><br><br>Solicitudes adición de medicamentos</h1>
  </div>
  ...
  <div class="row">
            ...
            <table class="table table-striped" id="myTable">
              ...
              <tbody>
                ...
                <?php if(!empty($query)){ ?>
                  ...
                  <td><?php echo $row->idnoPOS;?></td>
                  <td><?php echo $row->idSolicitante;?></td>
                  <td><?php echo $row->nameMedicine;?></td>
                  <td><?php echo $row->howitcomes;?></td>
                  <td><?php echo $row->whatitdoes;?></td>
                </tr>
                <?php } ?>
                <?php } ?>
              </tbody>
    ...
    <div class="col-lg-6">
      <form class="well" action="<?php echo base_url()."main/solicitudMedicine";?>" method="post" accept-charset="utf-8">
        <h2 class="form-signin-heading">Sugerencias, quejas o reclamos</h2>
        <?php echo validation_errors(); ?>
        
        <label>Id:</label>
        <input type="text" id="idnoPOS" class="form-control" name="idnoPOS" placeholder="Id" autocomplete="off" required>

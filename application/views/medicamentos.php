...
<!-- /******************************************************* 
 Autor : LABG1E2
 Tipo de programa: "Vista con la lista de los medicamentos del POS"
...
<html lang="en">
  <head>
    ...
    <title>Medicamentos - Tu Receta Médica</title>
  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="starter-template">
        <h1>Listado para el 2014 de medicamentos <br> ofrecidos por el POS<br></h1>
        <embed src="../assets/files/POS.pdf" width="850" height="550" href="../assets/files/POS.pdf"></embed>
        <p class="lead"><br></p>
      </div>
      <div class="mastfoot">
        <div class="inner">

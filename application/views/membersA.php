...
<!-- /******************************************************* 
 Autor : LABG1E2
 Tipo de programa: "Vista del administrador"
...
================================================== -->
  ...
  <div class="page-header">
        <h1><br><br>Solicitudes de registro</h1>
  </div>
  ...
  <div class="row">
    <div class="col-lg-6">
      ...
      <div class="col-lg-6">
      <form class="well" action="<?php echo base_url()."main/acceptSol";?>" method="post" accept-charset="utf-8">
        <h2 class="form-signin-heading">Solicitud de registro - Aceptar/Rechazar</h2>
